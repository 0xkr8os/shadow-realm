# Shadow Realm (Ethereum Proof-of-Stake Devnet)

## Prerequisites:
- prysmctl binary at root level
- docker-compose
- node 19
- pnpm
...
## Getting Started
```bash
# creates genesis files for consensus and execution client.
./create-genesis.sh 

# fetches remote state from beaconchain and merges it with genesis files.
node ./merge-genesis-with-state.js <slot>
```

Forked from [rauljordan/eth-pos-devnet](https://github.com/OffchainLabs/eth-pos-devnet)
